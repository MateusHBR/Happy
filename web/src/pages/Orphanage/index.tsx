...
import { Container, Main, OrphanageDetailsContent } from './styles';
        ...
        <div className="orphanage-details">
          ...
          <OrphanageDetailsContent>
            ...
            <div className="map-container">
              ...
              >
                <TileLayer
                  url={`https://api.mapbox.com/styles/v1/mapbox/light-v10/tiles/256/{z}/{x}/{y}@2x?access_token=${process.env.REACT_APP_MAP_MAPBOX_TOKEN}`}
                />
                <Marker
                  interactive={false}
                  icon={mapIcon}
